...
static long Testing_incrementRegisters (Testing *self)
{
	...
	time_t diff = getMicrosecondTime () - t0;
	if (diff > 0) {
		long double d = N_INC_OUTER_LOOPS;
		d *= N_INC_INNER_LOOPS;
		d *= N_INC_PER_INNER;
