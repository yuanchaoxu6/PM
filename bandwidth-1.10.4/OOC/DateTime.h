...
#define DECLARE_DATETIME_METHODS(TYPE_POINTER) \
	...
	const char *(*dateString) (TYPE_POINTER); \
...
extern const char *DateTime_dateString (DateTime *);
extern DateTime *DateTime_previousDay (DateTime *);
extern DateTime *DateTime_nextDay (DateTime *);

// Utility functions
extern uint64_t getMillisecondTime ();
extern void getDate (int *year, int *month, int *day);
extern const char *getTodayString ();
extern int getWeekDayNumber ();
